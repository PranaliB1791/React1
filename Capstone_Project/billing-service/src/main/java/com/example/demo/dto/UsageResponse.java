...
public class UsageResponse {
	...
	public UsageResponse(String id, Long userId, Long planId, int callMinutes, double dataUsageInGB, int smsCount,
	...
	// ... [copy from your usage microservice or DTO definition]
}
